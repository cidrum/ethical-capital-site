...
export const metadata: Metadata = {
  title: "Estate & Business Liquidation Services Acquisitions",
  description: "Seeking to acquire estate liquidation companies that manage complete estate sales, business liquidations, and personal property disposition for families, executors, and business owners.",
};
        ...
        <div className="max-w-[1140px] mx-auto px-[3.33%]">
          ...
          <div className="max-w-[900px]">
            ...
            <p className="text-xl leading-[160%] text-dark-blue-70">
              Acquiring professional estate liquidation companies that provide comprehensive services for estate sales, downsizing transitions, business closures, and personal property disposition.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-4 text-lg leading-[160%]">
                <p>
                  We seek established estate liquidation companies with expertise in managing complete estate sales, valuing personal property,
                  organizing and conducting sales events, and providing compassionate service to families during transitions.
                </p>
                <p>
                  Target businesses include estate sale companies serving executors, trustees, downsizing seniors, and families managing
                  inherited property, with capabilities spanning antiques, collectibles, furniture, and household goods.
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-sky-10 p-12">
              ...
              <ul className="space-y-4 text-lg leading-[160%]">
                <li className="flex items-start">
                  ...
                  <span>Relationships with estate attorneys and senior living communities</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Antique and collectible appraisal expertise</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Sale event planning and execution capabilities</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Marketing and customer database for estate sales</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Online auction platform integration</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Aging baby boomer population creates increasing demand for estate liquidation and downsizing services.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Commission-based model generates strong margins on estate sales with minimal capital requirements.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Strong referral networks with attorneys, financial advisors, and senior communities create consistent deal flow.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-lg leading-[160%]">Florida and Texas preferred, established local market presence</p>
                </div>
              </div>
              <div className="space-y-6">
                <div>
                ...
                <div>
                  <h4 className="text-xl font-semibold text-blue-marine mb-2">Professional Network</h4>
                  <p className="text-lg leading-[160%]">Strong relationships with estate attorneys and fiduciaries</p>
                </div>
                <div>
                  <h4 className="text-xl font-semibold text-blue-marine mb-2">Growth Opportunity</h4>
                  <p className="text-lg leading-[160%]">Potential for geographic expansion and online platform enhancement</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="max-w-[600px]">
              <p className="text-[28px] leading-[140%] text-white font-source-serif">
                Ready to discuss your estate liquidation business? Let&apos;s explore partnership and acquisition opportunities.
              </p>
            </div>

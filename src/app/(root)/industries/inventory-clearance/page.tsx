...
export const metadata: Metadata = {
  title: "Inventory Clearance & Overstock Solutions Acquisitions",
  description: "Seeking to acquire inventory liquidation companies specializing in excess inventory, overstock merchandise, and product clearance for manufacturers, distributors, and retailers.",
};
        ...
        <div className="max-w-[1140px] mx-auto px-[3.33%]">
          ...
          <div className="max-w-[900px]">
            <h1 className="font-playfair text-[76px] leading-[110%] text-dark-blue mb-8">
              Inventory Clearance & Overstock
            </h1>
            <p className="text-xl leading-[160%] text-dark-blue-70">
              Acquiring inventory liquidation specialists that help manufacturers, distributors, and retailers clear excess inventory, overstock merchandise, discontinued products, and seasonal goods.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-4 text-lg leading-[160%]">
                <p>
                  We seek established inventory liquidation companies with expertise in purchasing, valuing, and reselling excess inventory
                  across multiple product categories including consumer goods, electronics, apparel, home goods, and industrial products.
                </p>
                <p>
                  Target businesses include liquidators serving manufacturers with overproduction, retailers with seasonal excess,
                  distributors with slow-moving inventory, and importers with overstocked containers.
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-sky-10 p-12">
              ...
              <ul className="space-y-4 text-lg leading-[160%]">
                <li className="flex items-start">
                  ...
                  <span>Established supplier relationships and deal flow</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Product valuation and pricing expertise</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Multiple sales channels (wholesale, retail, online)</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Warehouse and logistics infrastructure</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Buyer network across discount and secondary markets</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Every manufacturer and retailer faces overstock situations, creating consistent deal flow and buying opportunities.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Purchasing distressed inventory at significant discounts enables strong profit margins through multiple sales channels.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Business model scales efficiently with larger deals, expanded product categories, and enhanced sales channels.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-lg leading-[160%]">Florida and Texas preferred, national sourcing capabilities valued</p>
                </div>
              </div>
              <div className="space-y-6">
                <div>
                ...
                <div>
                  <h4 className="text-xl font-semibold text-blue-marine mb-2">Supplier Relationships</h4>
                  <p className="text-lg leading-[160%]">Proven track record with manufacturers, distributors, and retailers</p>
                </div>
                <div>
                  <h4 className="text-xl font-semibold text-blue-marine mb-2">Growth Opportunity</h4>
                  <p className="text-lg leading-[160%]">Potential for expanded product categories and sales channel development</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="max-w-[600px]">
              <p className="text-[28px] leading-[140%] text-white font-source-serif">
                Ready to discuss your inventory liquidation business? Let&apos;s explore partnership and acquisition opportunities.
              </p>
            </div>

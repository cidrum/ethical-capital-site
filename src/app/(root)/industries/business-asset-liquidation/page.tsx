...
export const metadata: Metadata = {
  title: "Business Asset Liquidation Services Acquisitions",
  description: "Seeking to acquire business asset liquidation companies that help businesses sell equipment, inventory, and assets during closures or transitions.",
};

export default function BusinessAssetLiquidationPage() {
  return (
    <>
        ...
        <div className="max-w-[1140px] mx-auto px-[3.33%]">
          ...
          <div className="max-w-[900px]">
            ...
            <p className="text-xl leading-[160%] text-dark-blue-70">
              Acquiring liquidation companies that help businesses sell equipment, inventory, fixtures, and assets during closures, bankruptcies, or transitions.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-4 text-lg leading-[160%]">
                <p>
                  We seek established liquidation service providers with expertise in valuing, marketing, and selling business assets
                  including equipment, inventory, fixtures, and real property during business transitions or closures.
                </p>
                <p>
                  Target businesses include liquidators serving retail stores, restaurants, manufacturers, warehouses, and commercial
                  operations with comprehensive liquidation, auction, and asset recovery capabilities.
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-sky-10 p-12">
              ...
              <ul className="space-y-4 text-lg leading-[160%]">
                <li className="flex items-start">
                  ...
                  <span>Relationships with bankruptcy attorneys and business brokers</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Appraisal and asset valuation expertise</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Auction platform and buyer database</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Logistics and asset removal capabilities</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Marketing and sales expertise across asset categories</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
      ...
      <section className="w-full bg-white">
        <div className="max-w-[1140px] mx-auto px-[3.33%] py-24">
          <h2 className="font-source-serif text-[48px] leading-[110%] text-blue-marine mb-12">
            Why Business Asset Liquidation?
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Economic downturns increase business failures and closures, driving demand for liquidation services.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Large liquidation projects generate significant revenue opportunities with strong profit margins.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Specialized knowledge creates barriers to entry and enables premium pricing for professional liquidation services.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-lg leading-[160%]">Florida and Texas preferred, national reach beneficial</p>
                </div>
              </div>
              <div className="space-y-6">
                <div>
                ...
                <div>
                  <h4 className="text-xl font-semibold text-blue-marine mb-2">Referral Network</h4>
                  <p className="text-lg leading-[160%]">Strong relationships with attorneys, lenders, and business advisors</p>
                </div>
                <div>
                  <h4 className="text-xl font-semibold text-blue-marine mb-2">Growth Opportunity</h4>
                  <p className="text-lg leading-[160%]">Potential for geographic expansion and service line additions</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="max-w-[600px]">
              <p className="text-[28px] leading-[140%] text-white font-source-serif">
                Ready to discuss your asset liquidation business? Let&apos;s explore partnership and acquisition opportunities.
              </p>
            </div>

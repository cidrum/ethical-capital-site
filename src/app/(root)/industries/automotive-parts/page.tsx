...
export const metadata: Metadata = {
  title: "Automotive Parts & Accessories Distribution Acquisitions",
  description: "Seeking to acquire distributors of automotive parts, accessories, and tools serving repair shops and automotive service providers.",
};
        ...
        <div className="max-w-[1140px] mx-auto px-[3.33%]">
          ...
          <div className="max-w-[900px]">
            ...
            <p className="text-xl leading-[160%] text-dark-blue-70">
              Acquiring distributors of automotive aftermarket parts, tools, and accessories serving repair shops, dealerships, and fleet operators.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-4 text-lg leading-[160%]">
                <p>
                  We seek established distributors of automotive aftermarket parts serving independent repair shops,
                  dealerships, and fleet maintenance operations with broad product catalogs and fast delivery.
                </p>
                <p>
                  Target businesses include distributors of replacement parts, performance parts, tools, equipment,
                  diagnostic tools, and automotive accessories with strong inventory depth and multiple daily deliveries.
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-sky-10 p-12">
              ...
              <ul className="space-y-4 text-lg leading-[160%]">
                <li className="flex items-start">
                  ...
                  <span>Strong relationships with repair shops and service providers</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Multiple daily deliveries and pickup services</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Extensive parts catalog and cross-reference capability</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Knowledgeable counter staff with technical expertise</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
                  <span>Parts cataloging and inventory management systems</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-marine mr-3 text-2xl">•</span>
      ...
      <section className="w-full bg-white">
        <div className="max-w-[1140px] mx-auto px-[3.33%] py-24">
          <h2 className="font-source-serif text-[48px] leading-[110%] text-blue-marine mb-12">
            Why Automotive Parts Distribution?
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Large vehicle population requires constant maintenance and repair, creating consistent demand for parts.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Repair shops require multiple deliveries daily, creating high-frequency transactions and strong relationships.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-base leading-[160%]">
                Vehicle repair cannot wait, making parts availability a mission-critical service for repair shops.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-lg leading-[160%]">Diversified repair shop and service center accounts</p>
                </div>
                <div>
                  <h4 className="text-xl font-semibold text-blue-marine mb-2">Growth Opportunity</h4>
                  <p className="text-lg leading-[160%]">Potential for territory expansion and product line additions</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="max-w-[600px]">
              <p className="text-[28px] leading-[140%] text-white font-source-serif">
                Ready to discuss your automotive parts distribution business? Let&apos;s explore opportunities together.
              </p>
            </div>
